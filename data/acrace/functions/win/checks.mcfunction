...
## draw
execute if score allow_draw global matches 1.. if score winners internal matches 2.. as @a[tag=win] run function acrace:win/draw
## no draw
execute unless score winners internal matches 2.. as @a[tag=win,limit=1] run function acrace:win/go
...
## final winner
execute unless score allow_draw global matches 1.. if score winners internal matches 2.. as @a[tag=win,limit=1] run function acrace:win/go