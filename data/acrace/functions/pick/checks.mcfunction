...
## Stone Age
execute as @a[advancements={minecraft:story/mine_stone=true}] at @s unless score @s achievement.story_mine_stone matches 1.. run scoreboard players set @s achievement.claiming_points 1
...
## Getting an Upgrade
execute as @a[advancements={minecraft:story/upgrade_tools=true}] at @s unless score @s achievement.story_upgrade_tools matches 1.. run scoreboard players set @s achievement.claiming_points 1
...
## Acquire Hardware
execute as @a[advancements={minecraft:story/smelt_iron=true}] at @s unless score @s achievement.story_smelt_iron matches 1.. run scoreboard players set @s achievement.claiming_points 2
...
## Suit Up
execute as @a[advancements={minecraft:story/obtain_armor=true}] at @s unless score @s achievement.story_obtain_armor matches 1.. run scoreboard players set @s achievement.claiming_points 3
...
## Isn't It Iron Pick
execute as @a[advancements={minecraft:story/iron_tools=true}] at @s unless score @s achievement.story_iron_tools matches 1.. run scoreboard players set @s achievement.claiming_points 4
...
## Diamonds!
execute as @a[advancements={minecraft:story/mine_diamond=true}] at @s unless score @s achievement.story_mine_diamond matches 1.. run scoreboard players set @s achievement.claiming_points 6
...
execute as @a[advancements={minecraft:story/enter_the_nether=true}] at @s unless score @s achievement.story_enter_the_nether matches 1.. run scoreboard players set @s achievement.claiming_points 4
...
## Return to Sender
execute as @a[advancements={minecraft:nether/return_to_sender=true}] at @s unless score @s achievement.nether_return_to_sender matches 1.. run scoreboard players set @s achievement.claiming_points 5
...
## Those Were the Days
execute as @a[advancements={minecraft:nether/find_bastion=true}] at @s unless score @s achievement.nether_find_bastion matches 1.. run scoreboard players set @s achievement.claiming_points 5
...
## A Terrible Fortress
execute as @a[advancements={minecraft:nether/find_fortress=true}] at @s unless score @s achievement.nether_find_fortress matches 1.. run scoreboard players set @s achievement.claiming_points 4
...
## Oh Shiny
execute as @a[advancements={minecraft:nether/distract_piglin=true}] at @s unless score @s achievement.nether_distract_piglin matches 1.. run scoreboard players set @s achievement.claiming_points 5
...
## This Boat Has Legs
execute as @a[advancements={minecraft:nether/ride_strider=true}] at @s unless score @s achievement.nether_ride_strider matches 1.. run scoreboard players set @s achievement.claiming_points 4
...
## War Pigs
execute as @a[advancements={minecraft:nether/loot_bastion=true}] at @s unless score @s achievement.nether_loot_bastion matches 1.. run scoreboard players set @s achievement.claiming_points 5
...
execute as @a[advancements={minecraft:nether/use_lodestone=true}] at @s unless score @s achievement.nether_use_lodestone matches 1.. run scoreboard players set @s achievement.claiming_points 5
...
## Withering Heights
execute as @a[advancements={minecraft:nether/summon_wither=true}] at @s unless score @s achievement.nether_summon_wither matches 1.. run scoreboard players set @s achievement.claiming_points 10
...
## Local Brewery
execute as @a[advancements={minecraft:nether/brew_potion=true}] at @s unless score @s achievement.nether_brew_potion matches 1.. run scoreboard players set @s achievement.claiming_points 7
...
execute as @a[advancements={minecraft:nether/create_beacon=true}] at @s unless score @s achievement.nether_create_beacon matches 1.. run scoreboard players set @s achievement.claiming_points 6
...
## Voluntary Exile
execute as @a[advancements={minecraft:adventure/voluntary_exile=true}] at @s unless score @s achievement.adventure_voluntary_exile matches 1.. run scoreboard players set @s achievement.claiming_points 6
...
## Is It a Bird?
execute as @a[advancements={minecraft:adventure/spyglass_at_parrot=true}] at @s unless score @s achievement.adventure_spyglass_at_parrot matches 1.. run scoreboard players set @s achievement.claiming_points 3
...
## What a Deal!
execute as @a[advancements={minecraft:adventure/trade=true}] at @s unless score @s achievement.adventure_trade matches 1.. run scoreboard players set @s achievement.claiming_points 4
...
## Ol' Betsy
execute as @a[advancements={minecraft:adventure/ol_betsy=true}] at @s unless score @s achievement.adventure_ol_betsy matches 1.. run scoreboard players set @s achievement.claiming_points 3
...
## Surge Protector
execute as @a[advancements={minecraft:adventure/lightning_rod_with_villager_no_fire=true}] at @s unless score @s achievement.adventure_lightning_rod_with_villager_no_fire matches 1.. run scoreboard players set @s achievement.claiming_points 6
...
## Sweet Dreams
execute as @a[advancements={minecraft:adventure/sleep_in_bed=true}] at @s unless score @s achievement.adventure_sleep_in_bed matches 1.. run scoreboard players set @s achievement.claiming_points 2
...
## Hero of the Village
execute as @a[advancements={minecraft:adventure/hero_of_the_village=true}] at @s unless score @s achievement.adventure_hero_of_the_village matches 1.. run scoreboard players set @s achievement.claiming_points 9
...
## A Throwaway Joke
execute as @a[advancements={minecraft:adventure/throw_trident=true}] at @s unless score @s achievement.adventure_throw_trident matches 1.. run scoreboard players set @s achievement.claiming_points 4
...
## It Spreads
execute as @a[advancements={minecraft:adventure/kill_mob_near_sculk_catalyst=true}] at @s unless score @s achievement.adventure_kill_mob_near_sculk_catalyst matches 1.. run scoreboard players set @s achievement.claiming_points 3
...
## Take Aim
execute as @a[advancements={minecraft:adventure/shoot_arrow=true}] at @s unless score @s achievement.adventure_shoot_arrow matches 1.. run scoreboard players set @s achievement.claiming_points 2
...
## Postmortal
execute as @a[advancements={minecraft:adventure/totem_of_undying=true}] at @s unless score @s achievement.adventure_totem_of_undying matches 1.. run scoreboard players set @s achievement.claiming_points 8
...
## Hired Help
execute as @a[advancements={minecraft:adventure/summon_iron_golem=true}] at @s unless score @s achievement.adventure_summon_iron_golem matches 1.. run scoreboard players set @s achievement.claiming_points 10
...
## Star Trader
execute as @a[advancements={minecraft:adventure/trade_at_world_height=true}] at @s unless score @s achievement.adventure_trade_at_world_height matches 1.. run scoreboard players set @s achievement.claiming_points 14
...
## Sound of Music
execute as @a[advancements={minecraft:adventure/play_jukebox_in_meadows=true}] at @s unless score @s achievement.adventure_play_jukebox_in_meadows matches 1.. run scoreboard players set @s achievement.claiming_points 4
...
## Light as a Rabbit
execute as @a[advancements={minecraft:adventure/walk_on_powder_snow_with_leather_boots=true}] at @s unless score @s achievement.adventure_walk_on_powder_snow_with_leather_boots matches 1.. run scoreboard players set @s achievement.claiming_points 3
...
## Is It a Plane?
execute as @a[advancements={minecraft:adventure/spyglass_at_dragon=true}] at @s unless score @s achievement.adventure_spyglass_at_dragon matches 1.. run scoreboard players set @s achievement.claiming_points 7
...
execute as @a[advancements={minecraft:adventure/very_very_frightening=true}] at @s unless score @s achievement.adventure_very_very_frightening matches 1.. run scoreboard players set @s achievement.claiming_points 8
...
## Sniper Duel
execute as @a[advancements={minecraft:adventure/sniper_duel=true}] at @s unless score @s achievement.adventure_sniper_duel matches 1.. run scoreboard players set @s achievement.claiming_points 6
...
## Bullseye
execute as @a[advancements={minecraft:adventure/bullseye=true}] at @s unless score @s achievement.adventure_bullseye matches 1.. run scoreboard players set @s achievement.claiming_points 5
...
## Bee Our Guest
execute as @a[advancements={minecraft:husbandry/safely_harvest_honey=true}] at @s unless score @s achievement.husbandry_safely_harvest_honey matches 1.. run scoreboard players set @s achievement.claiming_points 2
...
execute as @a[advancements={minecraft:husbandry/breed_an_animal=true}] at @s unless score @s achievement.husbandry_breed_an_animal matches 1.. run scoreboard players set @s achievement.claiming_points 3
...
execute as @a[advancements={minecraft:husbandry/allay_deliver_item_to_player=true}] at @s unless score @s achievement.husbandry_allay_deliver_item_to_player matches 1.. run scoreboard players set @s achievement.claiming_points 5
...
execute as @a[advancements={minecraft:husbandry/ride_a_boat_with_a_goat=true}] at @s unless score @s achievement.husbandry_ride_a_boat_with_a_goat matches 1.. run scoreboard players set @s achievement.claiming_points 7
...
execute as @a[advancements={minecraft:husbandry/tame_an_animal=true}] at @s unless score @s achievement.husbandry_tame_an_animal matches 1.. run scoreboard players set @s achievement.claiming_points 3
...
## Fishy Business
execute as @a[advancements={minecraft:husbandry/fishy_business=true}] at @s unless score @s achievement.husbandry_fishy_business matches 1.. run scoreboard players set @s achievement.claiming_points 2
...
## Bukkit Bukkit
execute as @a[advancements={minecraft:husbandry/tadpole_in_a_bucket=true}] at @s unless score @s achievement.husbandry_tadpole_in_a_bucket matches 1.. run scoreboard players set @s achievement.claiming_points 3
...
## A Seedy Place
execute as @a[advancements={minecraft:husbandry/plant_seed=true}] at @s unless score @s achievement.husbandry_plant_seed matches 1.. run scoreboard players set @s achievement.claiming_points 1
...
## Birthday Song
execute as @a[advancements={minecraft:husbandry/allay_deliver_cake_to_note_block=true}] at @s unless score @s achievement.husbandry_allay_deliver_cake_to_note_block matches 1.. run scoreboard players set @s achievement.claiming_points 7
...
execute as @a[advancements={minecraft:husbandry/complete_catalogue=true}] at @s unless score @s achievement.husbandry_complete_catalogue matches 1.. run scoreboard players set @s achievement.claiming_points 8
...
## Tactical Fishing
execute as @a[advancements={minecraft:husbandry/tactical_fishing=true}] at @s unless score @s achievement.husbandry_tactical_fishing matches 1.. run scoreboard players set @s achievement.claiming_points 1
...
## A Balanced Diet
execute as @a[advancements={minecraft:husbandry/balanced_diet=true}] at @s unless score @s achievement.husbandry_balanced_diet matches 1.. run scoreboard players set @s achievement.claiming_points 10
...
## The Cutest Predator
execute as @a[advancements={minecraft:husbandry/axolotl_in_a_bucket=true}] at @s unless score @s achievement.husbandry_axolotl_in_a_bucket matches 1.. run scoreboard players set @s achievement.claiming_points 5
...
execute as @a[advancements={minecraft:husbandry/froglights=true}] at @s unless score @s achievement.husbandry_froglights matches 1.. run scoreboard players set @s achievement.claiming_points 12
