...
## Stone Age
execute as @a[advancements={minecraft:story/mine_stone=true}] at @s unless score @s achievement.story_mine_stone matches 1.. run scoreboard players operation @s achievement.claiming_points = story_mine_stone achievement.values
...
## Getting an Upgrade
execute as @a[advancements={minecraft:story/upgrade_tools=true}] at @s unless score @s achievement.story_upgrade_tools matches 1.. run scoreboard players operation @s achievement.claiming_points = story_upgrade_tools achievement.values
...
## Acquire Hardware
execute as @a[advancements={minecraft:story/smelt_iron=true}] at @s unless score @s achievement.story_smelt_iron matches 1.. run scoreboard players operation @s achievement.claiming_points = story_smelt_iron achievement.values
...
## Suit Up
execute as @a[advancements={minecraft:story/obtain_armor=true}] at @s unless score @s achievement.story_obtain_armor matches 1.. run scoreboard players operation @s achievement.claiming_points = story_obtain_armor achievement.values
...
## Hot Stuff
execute as @a[advancements={minecraft:story/lava_bucket=true}] at @s unless score @s achievement.story_lava_bucket matches 1.. run scoreboard players operation @s achievement.claiming_points = story_lava_bucket achievement.values
...
## Isn't It Iron Pick
execute as @a[advancements={minecraft:story/iron_tools=true}] at @s unless score @s achievement.story_iron_tools matches 1.. run scoreboard players operation @s achievement.claiming_points = story_iron_tools achievement.values
...
## Not Today, Thank You
execute as @a[advancements={minecraft:story/deflect_arrow=true}] at @s unless score @s achievement.story_deflect_arrow matches 1.. run scoreboard players operation @s achievement.claiming_points = story_deflect_arrow achievement.values
...
execute as @a[advancements={minecraft:story/form_obsidian=true}] at @s unless score @s achievement.story_form_obsidian matches 1.. run scoreboard players operation @s achievement.claiming_points = story_form_obsidian achievement.values
...
## Diamonds!
execute as @a[advancements={minecraft:story/mine_diamond=true}] at @s unless score @s achievement.story_mine_diamond matches 1.. run scoreboard players operation @s achievement.claiming_points = story_mine_diamond achievement.values
...
## Isn't It?
execute as @a[advancements={minecraft:story/diamond_tools=true}] at @s unless score @s achievement.story_diamond_tools matches 1.. run scoreboard players operation @s achievement.claiming_points = story_diamond_tools achievement.values
...
execute as @a[advancements={minecraft:story/enter_the_nether=true}] at @s unless score @s achievement.story_enter_the_nether matches 1.. run scoreboard players operation @s achievement.claiming_points = story_enter_the_nether achievement.values
...
execute as @a[advancements={minecraft:story/shiny_gear=true}] at @s unless score @s achievement.story_shiny_gear matches 1.. run scoreboard players operation @s achievement.claiming_points = story_shiny_gear achievement.values
...
## A Full Set
execute as @a[advancements={minecraft:story/diamond_armor=true}] at @s unless score @s achievement.story_diamond_armor matches 1.. run scoreboard players operation @s achievement.claiming_points = story_diamond_armor achievement.values
...
## Enchanter
execute as @a[advancements={minecraft:story/enchant_item=true}] at @s unless score @s achievement.story_enchant_item matches 1.. run scoreboard players operation @s achievement.claiming_points = story_enchant_item achievement.values
...
## Zombie Doctor
execute as @a[advancements={minecraft:story/cure_zombie_villager=true}] at @s unless score @s achievement.story_cure_zombie_villager matches 1.. run scoreboard players operation @s achievement.claiming_points = story_cure_zombie_villager achievement.values
...
## Eye Spy
execute as @a[advancements={minecraft:story/follow_ender_eye=true}] at @s unless score @s achievement.story_follow_ender_eye matches 1.. run scoreboard players operation @s achievement.claiming_points = story_follow_ender_eye achievement.values
...
## The End?
execute as @a[advancements={minecraft:story/enter_the_end=true}] at @s unless score @s achievement.story_enter_the_end matches 1.. run scoreboard players operation @s achievement.claiming_points = story_enter_the_end achievement.values
...
## Return to Sender
execute as @a[advancements={minecraft:nether/return_to_sender=true}] at @s unless score @s achievement.nether_return_to_sender matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_return_to_sender achievement.values
...
## Those Were the Days
execute as @a[advancements={minecraft:nether/find_bastion=true}] at @s unless score @s achievement.nether_find_bastion matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_find_bastion achievement.values
...
execute as @a[advancements={minecraft:nether/obtain_ancient_debris=true}] at @s unless score @s achievement.nether_obtain_ancient_debris matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_obtain_ancient_debris achievement.values
...
## Subspace Bubble
execute as @a[advancements={minecraft:nether/fast_travel=true}] at @s unless score @s achievement.nether_fast_travel matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_fast_travel achievement.values
...
## A Terrible Fortress
execute as @a[advancements={minecraft:nether/find_fortress=true}] at @s unless score @s achievement.nether_find_fortress matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_find_fortress achievement.values
...
execute as @a[advancements={minecraft:nether/obtain_crying_obsidian=true}] at @s unless score @s achievement.nether_obtain_crying_obsidian matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_obtain_crying_obsidian achievement.values
...
## Oh Shiny
execute as @a[advancements={minecraft:nether/distract_piglin=true}] at @s unless score @s achievement.nether_distract_piglin matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_distract_piglin achievement.values
...
## This Boat Has Legs
execute as @a[advancements={minecraft:nether/ride_strider=true}] at @s unless score @s achievement.nether_ride_strider matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_ride_strider achievement.values
...
## Uneasy Alliance
execute as @a[advancements={minecraft:nether/uneasy_alliance=true}] at @s unless score @s achievement.nether_uneasy_alliance matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_uneasy_alliance achievement.values
...
## War Pigs
execute as @a[advancements={minecraft:nether/loot_bastion=true}] at @s unless score @s achievement.nether_loot_bastion matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_loot_bastion achievement.values
...
execute as @a[advancements={minecraft:nether/use_lodestone=true}] at @s unless score @s achievement.nether_use_lodestone matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_use_lodestone achievement.values
...
## Cover Me in Debris
execute as @a[advancements={minecraft:nether/netherite_armor=true}] at @s unless score @s achievement.nether_netherite_armor matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_netherite_armor achievement.values
...
execute as @a[advancements={minecraft:nether/get_wither_skull=true}] at @s unless score @s achievement.nether_get_wither_skull matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_get_wither_skull achievement.values
...
## Into Fire
execute as @a[advancements={minecraft:nether/obtain_blaze_rod=true}] at @s unless score @s achievement.nether_obtain_blaze_rod matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_obtain_blaze_rod achievement.values
...
execute as @a[advancements={minecraft:nether/charge_respawn_anchor=true}] at @s unless score @s achievement.nether_charge_respawn_anchor matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_charge_respawn_anchor achievement.values
...
## Feels Like Home
execute as @a[advancements={minecraft:nether/ride_strider_in_overworld_lava=true}] at @s unless score @s achievement.nether_ride_strider_in_overworld_lava matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_ride_strider_in_overworld_lava achievement.values
...
execute as @a[advancements={minecraft:nether/explore_nether=true}] at @s unless score @s achievement.nether_explore_nether matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_explore_nether achievement.values
...
## Withering Heights
execute as @a[advancements={minecraft:nether/summon_wither=true}] at @s unless score @s achievement.nether_summon_wither matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_summon_wither achievement.values
...
## Local Brewery
execute as @a[advancements={minecraft:nether/brew_potion=true}] at @s unless score @s achievement.nether_brew_potion matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_brew_potion achievement.values
...
execute as @a[advancements={minecraft:nether/create_beacon=true}] at @s unless score @s achievement.nether_create_beacon matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_create_beacon achievement.values
...
## A Furious Cocktail
execute as @a[advancements={minecraft:nether/all_potions=true}] at @s unless score @s achievement.nether_all_potions matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_all_potions achievement.values
...
## Beaconator
execute as @a[advancements={minecraft:nether/create_full_beacon=true}] at @s unless score @s achievement.nether_create_full_beacon matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_create_full_beacon achievement.values
...
## How Did We Get Here?
execute as @a[advancements={minecraft:nether/all_effects=true}] at @s unless score @s achievement.nether_all_effects matches 1.. run scoreboard players operation @s achievement.claiming_points = nether_all_effects achievement.values
...
## Free the End
execute as @a[advancements={minecraft:end/kill_dragon=true}] at @s unless score @s achievement.end_kill_dragon matches 1.. run scoreboard players operation @s achievement.claiming_points = end_kill_dragon achievement.values
...
## The Next Generation
execute as @a[advancements={minecraft:end/dragon_egg=true}] at @s unless score @s achievement.end_dragon_egg matches 1.. run scoreboard players operation @s achievement.claiming_points = end_dragon_egg achievement.values
...
## Remote Getaway
execute as @a[advancements={minecraft:end/enter_end_gateway=true}] at @s unless score @s achievement.end_enter_end_gateway matches 1.. run scoreboard players operation @s achievement.claiming_points = end_enter_end_gateway achievement.values
...
## The End... Again...
execute as @a[advancements={minecraft:end/respawn_dragon=true}] at @s unless score @s achievement.end_respawn_dragon matches 1.. run scoreboard players operation @s achievement.claiming_points = end_respawn_dragon achievement.values
...
## You Need a Mint
execute as @a[advancements={minecraft:end/dragon_breath=true}] at @s unless score @s achievement.end_dragon_breath matches 1.. run scoreboard players operation @s achievement.claiming_points = end_dragon_breath achievement.values
...
execute as @a[advancements={minecraft:end/find_end_city=true}] at @s unless score @s achievement.end_find_end_city matches 1.. run scoreboard players operation @s achievement.claiming_points = end_find_end_city achievement.values
...
## Sky's the Limit
execute as @a[advancements={minecraft:end/elytra=true}] at @s unless score @s achievement.end_elytra matches 1.. run scoreboard players operation @s achievement.claiming_points = end_elytra achievement.values
...
execute as @a[advancements={minecraft:end/levitate=true}] at @s unless score @s achievement.end_levitate matches 1.. run scoreboard players operation @s achievement.claiming_points = end_levitate achievement.values
...
## Voluntary Exile
execute as @a[advancements={minecraft:adventure/voluntary_exile=true}] at @s unless score @s achievement.adventure_voluntary_exile matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_voluntary_exile achievement.values
...
## Is It a Bird?
execute as @a[advancements={minecraft:adventure/spyglass_at_parrot=true}] at @s unless score @s achievement.adventure_spyglass_at_parrot matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_spyglass_at_parrot achievement.values
...
## Monster Hunter
execute as @a[advancements={minecraft:adventure/kill_a_mob=true}] at @s unless score @s achievement.adventure_kill_a_mob matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_kill_a_mob achievement.values
...
## Creeper?
execute as @a[advancements={minecraft:adventure/kill_creeper=true}] at @s unless score @s achievement.adventure_kill_creeper matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_kill_creeper achievement.values
...
## What a Deal!
execute as @a[advancements={minecraft:adventure/trade=true}] at @s unless score @s achievement.adventure_trade matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_trade achievement.values
...
## Sticky Situation
execute as @a[advancements={minecraft:adventure/honey_block_slide=true}] at @s unless score @s achievement.adventure_honey_block_slide matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_honey_block_slide achievement.values
...
## Ol' Betsy
execute as @a[advancements={minecraft:adventure/ol_betsy=true}] at @s unless score @s achievement.adventure_ol_betsy matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_ol_betsy achievement.values
...
## Caves & Cliffs
execute as @a[advancements={minecraft:adventure/fall_from_world_height=true}] at @s unless score @s achievement.adventure_fall_from_world_height matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_fall_from_world_height achievement.values
...
## Sneak 100
execute as @a[advancements={minecraft:adventure/avoid_vibration=true}] at @s unless score @s achievement.adventure_avoid_vibration matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_avoid_vibration achievement.values
...
## Sweet Dreams
execute as @a[advancements={minecraft:adventure/sleep_in_bed=true}] at @s unless score @s achievement.adventure_sleep_in_bed matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_sleep_in_bed achievement.values
...
## Hero of the Village
execute as @a[advancements={minecraft:adventure/hero_of_the_village=true}] at @s unless score @s achievement.adventure_hero_of_the_village matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_hero_of_the_village achievement.values
...
## Is It a Balloon?
execute as @a[advancements={minecraft:adventure/spyglass_at_ghast=true}] at @s unless score @s achievement.adventure_spyglass_at_ghast matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_spyglass_at_ghast achievement.values
...
## A Throwaway Joke
execute as @a[advancements={minecraft:adventure/throw_trident=true}] at @s unless score @s achievement.adventure_throw_trident matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_throw_trident achievement.values
...
## It Spreads
execute as @a[advancements={minecraft:adventure/kill_mob_near_sculk_catalyst=true}] at @s unless score @s achievement.adventure_kill_mob_near_sculk_catalyst matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_kill_mob_near_sculk_catalyst achievement.values
...
## Take Aim
execute as @a[advancements={minecraft:adventure/shoot_arrow=true}] at @s unless score @s achievement.adventure_shoot_arrow matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_shoot_arrow achievement.values
...
## Monsters Hunted
execute as @a[advancements={minecraft:adventure/kill_all_mobs=true}] at @s unless score @s achievement.adventure_kill_all_mobs matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_kill_all_mobs achievement.values
...
## Postmortal
execute as @a[advancements={minecraft:adventure/totem_of_undying=true}] at @s unless score @s achievement.adventure_totem_of_undying matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_totem_of_undying achievement.values
...
## Hired Help
execute as @a[advancements={minecraft:adventure/summon_iron_golem=true}] at @s unless score @s achievement.adventure_summon_iron_golem matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_summon_iron_golem achievement.values
...
## Star Trader
execute as @a[advancements={minecraft:adventure/trade_at_world_height=true}] at @s unless score @s achievement.adventure_trade_at_world_height matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_trade_at_world_height achievement.values
...
## Two Birds, One Arrow
execute as @a[advancements={minecraft:adventure/two_birds_one_arrow=true}] at @s unless score @s achievement.adventure_two_birds_one_arrow matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_two_birds_one_arrow achievement.values
...
execute as @a[advancements={minecraft:adventure/whos_the_pillager_now=true}] at @s unless score @s achievement.adventure_whos_the_pillager_now matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_whos_the_pillager_now achievement.values
...
## Arbalistic
execute as @a[advancements={minecraft:adventure/arbalistic=true}] at @s unless score @s achievement.adventure_arbalistic matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_arbalistic achievement.values
...
## Adventuring Time
execute as @a[advancements={minecraft:adventure/adventuring_time=true}] at @s unless score @s achievement.adventure_adventuring_time matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_adventuring_time achievement.values
...
## Sound of Music
execute as @a[advancements={minecraft:adventure/play_jukebox_in_meadows=true}] at @s unless score @s achievement.adventure_play_jukebox_in_meadows matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_play_jukebox_in_meadows achievement.values
...
## Is It a Plane?
execute as @a[advancements={minecraft:adventure/spyglass_at_dragon=true}] at @s unless score @s achievement.adventure_spyglass_at_dragon matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_spyglass_at_dragon achievement.values
...
execute as @a[advancements={minecraft:adventure/very_very_frightening=true}] at @s unless score @s achievement.adventure_very_very_frightening matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_very_very_frightening achievement.values
...
## Sniper Duel
execute as @a[advancements={minecraft:adventure/sniper_duel=true}] at @s unless score @s achievement.adventure_sniper_duel matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_sniper_duel achievement.values
...
## Bullseye
execute as @a[advancements={minecraft:adventure/bullseye=true}] at @s unless score @s achievement.adventure_bullseye matches 1.. run scoreboard players operation @s achievement.claiming_points = adventure_bullseye achievement.values
...
## Bee Our Guest
execute as @a[advancements={minecraft:husbandry/safely_harvest_honey=true}] at @s unless score @s achievement.husbandry_safely_harvest_honey matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_safely_harvest_honey achievement.values
...
execute as @a[advancements={minecraft:husbandry/breed_an_animal=true}] at @s unless score @s achievement.husbandry_breed_an_animal matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_breed_an_animal achievement.values
...
execute as @a[advancements={minecraft:husbandry/allay_deliver_item_to_player=true}] at @s unless score @s achievement.husbandry_allay_deliver_item_to_player matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_allay_deliver_item_to_player achievement.values
...
execute as @a[advancements={minecraft:husbandry/ride_a_boat_with_a_goat=true}] at @s unless score @s achievement.husbandry_ride_a_boat_with_a_goat matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_ride_a_boat_with_a_goat achievement.values
...
execute as @a[advancements={minecraft:husbandry/tame_an_animal=true}] at @s unless score @s achievement.husbandry_tame_an_animal matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_tame_an_animal achievement.values
...
## Glow and Behold!
execute as @a[advancements={minecraft:husbandry/make_a_sign_glow=true}] at @s unless score @s achievement.husbandry_make_a_sign_glow matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_make_a_sign_glow achievement.values
...
## Fishy Business
execute as @a[advancements={minecraft:husbandry/fishy_business=true}] at @s unless score @s achievement.husbandry_fishy_business matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_fishy_business achievement.values
...
## Total Beelocation
execute as @a[advancements={minecraft:husbandry/silk_touch_nest=true}] at @s unless score @s achievement.husbandry_silk_touch_nest matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_silk_touch_nest achievement.values
...
## Bukkit Bukkit
execute as @a[advancements={minecraft:husbandry/tadpole_in_a_bucket=true}] at @s unless score @s achievement.husbandry_tadpole_in_a_bucket matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_tadpole_in_a_bucket achievement.values
...
## A Seedy Place
execute as @a[advancements={minecraft:husbandry/plant_seed=true}] at @s unless score @s achievement.husbandry_plant_seed matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_plant_seed achievement.values
...
## Wax On
execute as @a[advancements={minecraft:husbandry/wax_on=true}] at @s unless score @s achievement.husbandry_wax_on matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_wax_on achievement.values
...
## Two by Two
execute as @a[advancements={minecraft:husbandry/bred_all_animals=true}] at @s unless score @s achievement.husbandry_bred_all_animals matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_bred_all_animals achievement.values
...
## Birthday Song
execute as @a[advancements={minecraft:husbandry/allay_deliver_cake_to_note_block=true}] at @s unless score @s achievement.husbandry_allay_deliver_cake_to_note_block matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_allay_deliver_cake_to_note_block achievement.values
...
execute as @a[advancements={minecraft:husbandry/complete_catalogue=true}] at @s unless score @s achievement.husbandry_complete_catalogue matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_complete_catalogue achievement.values
...
## Tactical Fishing
execute as @a[advancements={minecraft:husbandry/tactical_fishing=true}] at @s unless score @s achievement.husbandry_tactical_fishing matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_tactical_fishing achievement.values
...
execute as @a[advancements={minecraft:husbandry/leash_all_frog_variants=true}] at @s unless score @s achievement.husbandry_leash_all_frog_variants matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_leash_all_frog_variants achievement.values
...
## A Balanced Diet
execute as @a[advancements={minecraft:husbandry/balanced_diet=true}] at @s unless score @s achievement.husbandry_balanced_diet matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_balanced_diet achievement.values
...
## Serious Dedication
execute as @a[advancements={minecraft:husbandry/obtain_netherite_hoe=true}] at @s unless score @s achievement.husbandry_obtain_netherite_hoe matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_obtain_netherite_hoe achievement.values
...
## Wax Off
execute as @a[advancements={minecraft:husbandry/wax_off=true}] at @s unless score @s achievement.husbandry_wax_off matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_wax_off achievement.values
...
## The Cutest Predator
execute as @a[advancements={minecraft:husbandry/axolotl_in_a_bucket=true}] at @s unless score @s achievement.husbandry_axolotl_in_a_bucket matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_axolotl_in_a_bucket achievement.values
...
execute as @a[advancements={minecraft:husbandry/froglights=true}] at @s unless score @s achievement.husbandry_froglights matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_froglights achievement.values
...
execute as @a[advancements={minecraft:husbandry/kill_axolotl_target=true}] at @s unless score @s achievement.husbandry_kill_axolotl_target matches 1.. run scoreboard players operation @s achievement.claiming_points = husbandry_kill_axolotl_target achievement.values
