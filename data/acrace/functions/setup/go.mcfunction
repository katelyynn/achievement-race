...
## page actions
tellraw @s ["",{"text":"\n[","color":"white"},{"text":"←","color":"gray","clickEvent":{"action":"run_command","value":"/function acrace:setup/page/down"}},{"text":"] \u0020 \u0020","color":"white"},"Page ",{"score":{"name":"@s","objective":"setup.page_display"}}," of 2",{"text":"\u0020 \u0020 [","color":"white"},{"text":"→","color":"gray","clickEvent":{"action":"run_command","value":"/function acrace:setup/page/up"}},{"text":"]","color":"white"}]
